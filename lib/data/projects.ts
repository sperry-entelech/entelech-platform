...
export const entelechProjects: EntelechProject[] = [
  ...
  {
    id: 'entelech-website',
    name: 'Entelech Website',
    description: 'Main company website - managed by Claude code builds',
    category: 'marketing',
    status: 'active',
    integrationType: 'external',
    githubRepo: 'https://github.com/sperry-entelech/entelech-platform',
    githubRepoPath: 'website',
    techStack: ['Claude Code', 'Static Site'],
    icon: 'Globe',
    tags: ['website', 'marketing', 'public-facing'],
    metadata: {
      lastUpdated: '2025-01-29',
      notes: 'Managed via Claude code generation and builds',
    },
  },
  {
    id: 'audit-request-form',
    name: 'Free Audit Request Form',
    description: 'Client-facing form for free business audits - Basic, Standard, Comprehensive levels',
    category: 'marketing',
    status: 'active',
    integrationType: 'native',
    githubRepo: 'https://github.com/sperry-entelech/entelech-platform',
    githubRepoPath: 'app/audit',
    techStack: ['TypeScript', 'Next.js'],
    icon: 'FileCheck',
    tags: ['audit', 'lead-generation', 'client-facing', 'campaigns'],
    metadata: {
      internalUrl: '/audit',
      lastUpdated: '2025-01-29',
      notes: 'Used for rotational campaigns and promotions',
    },
  },
  {
